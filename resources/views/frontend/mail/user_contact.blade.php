                                                                                    ...
                                                                                    <tr>
																						<td class="pb-50" style="padding-bottom: 50px;">
																							<table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse;">
                                                                                                <tr>
                                                                                                    <td class="text-16 lh-26 pb-25" style="font-size: 16px; color: #000000; font-family: 'PT Sans', Arial, sans-serif; min-width: auto !important; line-height: 26px; padding-left:10px;">
                                                                                                        <h4>Name</h4>
                                                                                                    </td>
                                                                                                    <td class="text-16 lh-26 pb-25" style="font-size: 16px; color: #000000; font-family: 'PT Sans', Arial, sans-serif; min-width: auto !important; line-height: 26px; padding-left:10px;">
                                                                                                        <span>{{$data['name']}}</span>
