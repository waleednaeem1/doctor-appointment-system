...
<head>
	...
	<style type="text/css" media="screen">
		...
		.gradient { background: linear-gradient(to right, #1E157D 0%,#1E15BC 100%); }

		.btn-secondary { border-radius: 10px; background: linear-gradient(to right, #1E157D 0%,#1E15BC 100%); }
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="mpx-10">
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td class="gradient pt-10" style="border-radius: 10px 10px 0 0; padding-top: 10px;" bgcolor="#1E157D">
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="https://dev.searchavet.com/"><img
                                                                                    src="https://dev.searchavet.com/assets/images/logoIcon/logo.png"  alt="" style="width:270px; margin-left: 55px; margin-top: 13px;"></a>
																			</td>
																		</tr>
																	</table>
																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="pb-50" style="padding-bottom: 50px;">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td align="center" class="title-36 a-center pb-15" style="font-size:36px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; padding-bottom: 15px;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="padding: 15px; text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; padding-bottom: 25px;">
                                                                                            <p style="color:rgb(0, 0, 0); margin-left: 31px !important; margin-right: 31px !important;">
                                                                                                Thank you for signing up for SearchAVet you can safely delete this email. To get you started, tap the button below to verify your email address.If you did not create an account with SearchAVet you can safely delete this email.</p> <br><br>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="display: grid;">
                                                                                        <td align="center">
                                                                                            ...
                                                                                            <table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px;">
                                                                                                <tbody><tr>
                                                                                                    <td class="btn-16 c-white l-white" bgcolor="#1E15BC" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
                                                                                                        <a href="{{ $verificationUrl }}" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                                                                                            <span class="link c-white" style="text-decoration:none; color:#ffffff;">Verify Your Email</span>
                                                                                                        </a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                        ...
                                                                                        <td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; padding-bottom: 25px;">
                                                                                            <p style="margin: 31px !important; margin-top: 15px !important; color:rgb(0, 0, 0);">
                                                                                                Thank you. <br>
                                                                                                Regards.<br>
                                                                                                SearchAVet Team
                                                                                            </p>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="/" target="_blank"><img src="{{ url('/assets/icons/ico_facebook.png') }}" width="34" height="34" border="0" alt="" /></a>
                                                                            </td>
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="/" target="_blank"><img src="{{ url('/assets/icons/ico_instagram.png') }}" width="34" height="34" border="0" alt="" /></a>
                                                                            </td>
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="/" target="_blank"><img src="{{ url('/assets/icons/ico_twitter1.png') }}" width="34" height="34" border="0" alt="" /></a>
                                                                            </td>
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="/" target="_blank"><img src="{{ url('/assets/icons/ico_linkedin.png') }}" width="34" height="34" border="0" alt="" /></a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <!-- END Socials -->
                                                            ...
                                                            <tr>
                                                                <td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                                                    61-21 Springfield Blvd, Suite 396 Oakland Gardens, NY 11364
                                                                    <br />
                                                                    <a href="tel:5165937101" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">+1 (516) 593-7400</span></a>
                                                                    <br />
                                                                    <a href="mailto:info@searchavet.com" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">info@searchavet.com </span></a> - <a href="www.searchavet.com" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">www.searchavet.com </span></a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center">
                                                                    ...
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="" target="_blank"><img src="{{ url('/assets/icons/btn_appstore.png') }}" width="117" height="40" border="0" alt="" /></a>
                                                                            </td>
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="" target="_blank"><img src="{{ url('/assets/icons/btn_gplay.png') }}" width="117" height="40" border="0" alt="" /></a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <!-- END Download App -->
