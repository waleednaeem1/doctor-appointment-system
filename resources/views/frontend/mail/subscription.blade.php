																		...
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="https://dev.searchavet.com/"><img
                                                                                    src="https://dev.searchavet.com/assets/images/logoIcon/logo.png"  alt="" style="width:250px; margin-left: 55px; margin-top: 13px;"></a>
																			</td>
																		</tr>
																	</table>
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 302px;">
																								<tr>
																									<td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
																										<a href="#" action="javascript:void();"><img src="https://dev.searchavet.com/assets/icons/img_intro_1.png" width="368" height="296" border="0" alt="" /></a>
																									</td>
																								</tr>
																								<tr>
																									<td class="text-16 lh-26 pb-25" style="font-size:16px; color:#000000; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; padding-bottom: 25px;">
                                                                                                        <p>Dear @if($data['email']){{$data['email']}} @else User @endif,</p>
                                                                                                        <p>Thank you for signing up for the Search a Vet Newsletter. We appreciate your support. For more information on Search a Vet download our mobile app and follow us on Social Media.</p>
                                                                                                    </td>
																								</tr>
																							</table>
																						</td>
