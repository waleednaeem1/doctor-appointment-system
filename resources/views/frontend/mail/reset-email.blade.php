...
<head>
	...
	<style type="text/css" media="screen">
		...
		a { color:#1c18f3; text-decoration:none }
		...
		.l-pink a { color: #f88385; }
		.l-grey a { color: #6e6e6e; }
		.l-purple a { color: #f88385; }

		.gradient { background: linear-gradient(to right, #1c18f3 0%,#f88385 100%); }

		.btn-secondary { border-radius: 10px; background: linear-gradient(to right, #1c18f3 0%,#f88385 100%); }
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="mpx-10">
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td class="gradient pt-10" style="border-radius: 10px 10px 0 0; padding-top: 10px;" bgcolor="#f88385">
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																		...
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="https://dev.searchavet.com/"><img
                                                                                    src="https://dev.searchavet.com/assets/images/logoIcon/logo.png"  alt="" style="width:200px; margin-left: 55px; margin-top: 13px;"></a>
																			</td>
																		</tr>
																	</table>
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 302px;">
																								...
																								<tr>
																									<td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
																										We've received a Password Reset Request from your Account. OTP Code will be expired within 60 Seconds. After that, you'll have to ask for a new one.
																								...
																								<tr>
																									<td align="center">
																										...
																										<table border="0" cellspacing="0" cellpadding="0" style="min-width: 280px;">
																											<tr>
																												<td class="btn-16 c-white l-white" bgcolor="#1c18f3" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff; width: 2rem;
                                                                                                                padding: 1rem;">
