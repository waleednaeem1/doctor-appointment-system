                ...
                <div class="align-items-center col-lg-6 col-md-8 col-sm-11 col-xl-6 col-xxl-6 d-flex">
                    <div class="">
                        ...
                        <div class="login-wrapper__body bg-white" style="border-bottom-right-radius: 23px !important; border-bottom-left-radius: 23px !important;">
                            ...
                            <form action="{{ route('doctor.password.verify.code') }}" method="POST" class="cmn-form verify-gcaptcha login-form">
                                @csrf
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <a href="{{ route('doctor.password.reset', ['email' => $email]) }}" class="forget-text">@lang('Try to send again')</a>
                                </div>
                                <button type="submit" class="btn logInBtn w-100 mt-4">@lang('Submit')</button>
                            </form>
                            <a href="{{ route('doctor.login') }}" class="text-black mt-4"><i class="las la-sign-in-alt" aria-hidden="true"></i>@lang('Back to Login')</a>
                        </div>
                    </div>
                </div>
            </div>
