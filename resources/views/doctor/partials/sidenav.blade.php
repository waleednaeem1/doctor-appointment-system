                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('doctor.info*', 2) }} ">
                        <ul>
                            ...
                            {{-- <li class="sidebar-menu-item {{ menuActive('doctor.info.fee.structure') }} ">
                                <a href="{{ route('doctor.info.fee.structure') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Fee Structure')</span>
                                </a>
                            </li> --}}
                        </ul>
                    </div>
