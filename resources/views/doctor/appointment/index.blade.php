        ...
        <div class="modal-dialog" style="max-width: 650px" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <ul class="list-group-flush list-group">
                                <li class="list-group-item justify-content-between align-items-center fw-bold">
                                    ...
                                    <textarea class="disease"></textarea>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    {{-- <hr> --}}
                    <h5 class="modal-title mt-4 mb-3">@lang('Payment History')</h5>
                    <div class="row" style="padding-left: 10px;padding-right: 10px;">
                        <div class="col-md-6 border">
                            <ul class="list-group-flush list-group">
                                <li class="list-group-item d-flex justify-content-between align-items-center fw-bold">
                    ...
                    <div class="row mt-3 mb-3" style="padding-left: 10px; padding-right: 10px;">
                        <div class="col-md-6 border">
                            <ul class="list-group-flush list-group">
                                <li class="list-group-item d-flex justify-content-between align-items-center fw-bold">
                                    @lang('Status') :
    ...
    <script>
        (function($) {
            ...
            $('.detailBtn').on('click', function() {
                ...
                if(resourse.disease != null || resourse.disease == ''){
