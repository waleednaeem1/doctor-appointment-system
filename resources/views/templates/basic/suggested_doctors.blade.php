    ...
    <section class="appoint-section ptb-80">
        <div class="container">
            ...
            <div class="row justify-content-center ml-b-30">
                @if(!$doctors->isEmpty())
                <p>{{ $vetName }} does not treat {{ $petTypeName }} species. Please select from below to schedule an appointment.</p>
                @endif
        ...
        <div class="booking-btn mb-2 mt-4 text-center">
            <a href="javascript:window.history.back();" class="cmn-btn">@lang('Go Back')</a>
            @if($doctors->count() > 5)
            <a href="{{ route('moreVeterinarians') }}" class="cmn-btn">@lang('View More')</a>
            @endif
        </div>
    </section>
@endsection
