                                ...
                                <div class="col-lg-2 col-md-6 col-sm-6 mrb-30">
                                    <div class="booking-item">
                                        <div class="booking-thumb">
                                            <a href="{{ route('getpetsdiseases', $petType->id ) }}">
                                            <img src="{{ getImage(getFilePath('pets') . '/' . @$petType->image, getFileSize('pets')) }}" alt="@lang('pets')" style="width: 284.4px;height: 175.4px;"></a>
                                            <span class="doc-deg">
                                                {{-- <a href="{{ route('pet.details', $petType->id ) }}">{{$petType->name}}</a> --}}
                                                <a href="{{ route('getpetsdiseases', $petType->id ) }}">{{$petType->name}}</a>
                                            </span>
                                ...
                                <div class="col-lg-2 col-md-6 col-sm-6 mrb-30">
                                    <div class="booking-item">
                                        <div class="booking-thumb">
                                            ...
                                            <a href="{{ route('getpetsdiseases',[$userPet->pet_type_id,$userPet->id] ) }}">
                                                <img src="{{ getImage(getFilePath('pets') . '/' . @$image->attachment, getFileSize('pets')) }}" alt="@lang('pets')" style="width: 284.4px;height: 175.4px;">
                                            </a>
                                            <span class="fav-btn"><i class="fas fa-medal"></i></span>
                                        </div>
