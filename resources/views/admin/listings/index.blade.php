                                ...
                                @forelse($allListings as $key => $listing)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="avatar avatar--md">
                                                ...
                                                if (getenv('APP_ENV') === 'local') {
                                                    $imageSrc = "https://www.searchavet.com/laravel_project/public/storage/item/" . $listing->item_image;
                                                } else {
                                                    $imageSrc = asset("assets/admin/images/listing/" . $listing->item_image);
                                                }
                                                ?>
                                                <img src="<?php echo $imageSrc; ?>" alt="Listing Image">
                                            </div>
                                        </td>
                                        <td>{{ $listing->item_title}}</td>
                                        <td>{{ $listing->item_slug}}</td>
                                        <td>{{ $listing->country_id}}</td>
                                        <td>{{ $listing->state_id}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.listings.editpage', $listing->id)}}" type="button" class="btn btn-sm btn-outline--primary">
                                                <i class="la la-pencil"></i>@lang('Edit')
                                            </a>
                                        </td>
                                    </tr>
...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('admin.listings.form')}}" type="button" class="btn btn-sm btn-outline--primary">
