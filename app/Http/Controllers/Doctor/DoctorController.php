...
class DoctorController extends Controller
{
    ...
    public function feeStructure()
    {
        ...
        $vetId = auth()->guard('doctor')->user()->id;
        $feesStructures = FeeStructure::where('doctor_id', $vetId)->get();
        return view('doctor.info.fee_structure', compact('pageTitle', 'feesStructures'));
    }

    public function feeStructureUpdate(Request $request)
    {
        $request->validate([
            'start_time' => 'required',
            'end_time'   => 'required',
        ...
        $vet = auth()->guard('doctor')->user();
        FeeStructure::where('doctor_id', $vet->id)->delete();
